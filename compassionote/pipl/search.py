...
class SearchAPIRequest(object):
    ...
    for performance.
    CONTACT-PREMIUM-DEMO-3ol7wsi61sexqh3zsu8fizol
    CONTACT-DEMO-dbx06y1r1ruld26jz1imxh85
    SOCIAL-PREMIUM-DEMO-w5tgwin0x3p7tpy9pd3b47hq
    SOCIAL-DEMO-xc6oajnbb47paw52gpaqu520
    BUSINESS-PREMIUM-DEMO-4ku9l1jksuwf9j2w7bojteyx
    BUSINESS-DEMO-ku1j69r74ra2deydwavuvegk
    BUSINESS-PREMIUM-gkbkm1tn3q1406u1l5arsyrx
    """
    ...
    default_api_key = 'SOCIAL-PREMIUM-DEMO-w5tgwin0x3p7tpy9pd3b47hq'
